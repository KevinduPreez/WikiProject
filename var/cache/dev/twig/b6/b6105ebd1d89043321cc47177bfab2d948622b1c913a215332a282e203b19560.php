...
$context["key"] == "hit_read_ratio")) {
                    ...
                    foreach ($context['_seq'] as $context["_key"] => $context["call"]) {
                        ...
                        echo "()</td>
                                        <td>";
                        // line 142
                        echo $this->extensions['Symfony\Bundle\WebProfilerBundle\Twig\WebProfilerExtension']->dumpData($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["call"], "value", [], "any", false, false, false, 142), "result.html.twig", [], "any", false, false, false, 142), 2);
                        echo "</td>
                                    </tr>
                                ";
                        ++$context['loop']['index0'];
...
{% block panel %}
                            ...
                            <table>
                                ...
                                {% for call in calls %}
                                    <tr>
                                        ...
                                        <td>{{ profiler_dump(call.value.result.html.twig, maxDepth=2) }}</td>
                                    </tr>
                                {% endfor %}
                                </tbody>
                            </table>
    ...
    {% endif %}
{% endblock %}
", "@WebProfiler/Collector/cache.html.twig", "/Users/Kevin/CodeProjetcs/WikiProject/vendor/symfony/web-profiler-bundle/Resources/views/Collector/cache.html.twig");
    }
}
