            ...
            foreach ($context['_seq'] as $context["_key"] => $context["decision"]) {
                ...
                echo "</td>
                        <td class=\"font-normal\">
                            ";
                // line 313
                echo ((twig_get_attribute($this->env, $this->source, $context["decision"], "result.html.twig", [], "any", false, false, false, 313)) ? ("<span class=\"label status-success same-width\">GRANTED</span>") : ("<span class=\"label status-error same-width\">DENIED</span>"));
                // line 316
                echo "
                        </td>
                        <td>
...
{% block panel %}
    ...
    {% endif %}
{% endblock %}
", "@Security/Collector/security.html.twig", "/Users/Kevin/CodeProjetcs/WikiProject/vendor/symfony/security-bundle/Resources/views/Collector/security.html.twig");
    }
}
